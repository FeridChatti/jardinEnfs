...
public class EvenementService {
    ...
    public Evenement getEvenement(int id) {evenements=ListeEvenementJardin(2+"");
        Evenement ev= (Evenement) evenements.stream().filter(e->e.getId()==id).collect(Collectors.toList()).get(0);
